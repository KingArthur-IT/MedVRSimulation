...
function addSecondRoom(){
	...
	Obj2.position.copy(new THREE.Vector3(0.5, -1.5, -1.3));
	...
	Obj3.position.copy(new THREE.Vector3(-1.72, -1.45, -8.0));
	Obj3.rotation.setFromVector3(new THREE.Vector3(0.0, - Math.PI / 2, 0.0))
